...
const countryCurrencyMap: Record<string, string> = {
  AD: 'EUR', AL: 'ALL', AM: 'AMD', AR: 'ARS', AT: 'EUR', AU: 'AUD', AE: 'AED', AG: 'XCD',
  BB: 'BBD', BE: 'EUR', BG: 'BGN', BH: 'BHD', BN: 'BND', BR: 'BRL', BS: 'BSD', BZ: 'BZD',
  CA: 'CAD', CH: 'CHF', CL: 'CLP', CN: 'CNY', CR: 'CRC', CY: 'EUR', CZ: 'CZK',
  DE: 'EUR', DK: 'DKK', DM: 'XCD', DO: 'DOP',
  EE: 'EUR', EG: 'EGP', ES: 'EUR',
  FI: 'EUR', FR: 'EUR',
  GB: 'GBP', GD: 'XCD', GE: 'GEL', GR: 'EUR', GY: 'GYD',
  HR: 'EUR', HU: 'HUF',
  ID: 'IDR', IE: 'EUR', IS: 'ISK', IT: 'EUR',
  JM: 'JMD', JP: 'JPY',
  KN: 'XCD', KR: 'KRW', KW: 'KWD',
  LC: 'XCD', LI: 'CHF', LT: 'EUR', LU: 'EUR', LV: 'EUR',
  MC: 'EUR', MD: 'MDL', ME: 'EUR', MK: 'MKD', MT: 'EUR', MU: 'MUR', MV: 'MVR', MY: 'MYR',
  NL: 'EUR', NO: 'NOK', NZ: 'NZD',
  OM: 'OMR',
  PA: 'PAB', PE: 'PEN', PH: 'PHP', PL: 'PLN', PT: 'EUR', PY: 'PYG',
  QA: 'QAR',
  RO: 'RON', RS: 'RSD',
  SA: 'SAR', SC: 'SCR', SE: 'SEK', SG: 'SGD', SI: 'EUR', SK: 'EUR', SM: 'EUR', SR: 'SRD', SV: 'USD',
  TH: 'THB', TR: 'TRY', TT: 'TTD',
  US: 'USD', UY: 'UYU',
  VC: 'XCD', VN: 'VND',
  ZA: 'ZAR',
};

...
export const LLM_KEY_PUBLIC_PATHS = [
  ...
  "/us/faq",
  "/us/pricing",
  "/us/lead-exchange-workflow",
  "/us/partner-verification",
  "/us/multi-region-handoff-governance",
  "/us/lead-routing-signals",
  "/us/verification-evidence-checklist",
  "/us/regional-handoff-playbooks",
  "/uk",
  "/uk/about",
  "/uk/how-it-works",
  "/uk/faq",
  "/uk/pricing",
  "/uk/lead-exchange-workflow",
  "/uk/partner-verification",
  "/uk/multi-region-handoff-governance",
  "/uk/lead-routing-signals",
  "/uk/verification-evidence-checklist",
  "/uk/regional-handoff-playbooks",
  "/au",
  "/au/about",
  "/au/how-it-works",
  "/au/faq",
  "/au/pricing",
  "/au/lead-exchange-workflow",
  "/au/partner-verification",
  "/au/multi-region-handoff-governance",
  "/au/lead-routing-signals",
  "/au/verification-evidence-checklist",
  "/au/regional-handoff-playbooks",
  "/login",
  "/register",
  "/sitemap.xml",
  "/robots.txt",
